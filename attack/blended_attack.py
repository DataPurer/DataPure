...
def add_args(parser):
    ...
    parser.add_argument('--steplr_gamma', type=float, default=0.2)
    parser.add_argument('--sgd_momentum', type=float)
    parser.add_argument('--wd', type=float, help='weight decay of sgd')
    parser.add_argument('--steplr_milestones', type=list, default=[60,120,160])
    ...
    parser.add_argument('--save_folder_name', type=str, default='test', #blended_preresnet_scratch
