...
def add_args(parser):
    ...
    parser.add_argument('--yaml_path', type=str, default='../config/attack/badnet/cifar10.yaml',
    ...
    parser.add_argument('--steplr_stepsize', type=int, default=20)
    parser.add_argument('--steplr_gamma', type=float, default=0.1)
    parser.add_argument('--sgd_momentum', type=float)
    parser.add_argument('--wd', type=float, help='weight decay of sgd')
    parser.add_argument('--steplr_milestones', type=list, default=[100,150,180])
    ...
    parser.add_argument('--save_folder_name', type=str, default='test', #fix_patch_preresnet_scratch
...
def main():
    ...
    #print(train_img_transform) #Resize,RandomCrop,RandomHorizontalFlip,ToTensor,Normalize(mean=[0.4914, 0.4822, 0.4465], std=[0.247, 0.243, 0.261])
    #print(test_img_transform) #Resize,ToTensor,Normalize(mean=[0.4914, 0.4822, 0.4465], std=[0.247, 0.243, 0.261])
    #print(train_label_transfrom, test_label_transform) #None, None
    ...
    #adv_train_ds.data = np.load("../results/" + args.attack+ "/clean_data.npy", allow_pickle=True).tolist()
    #adv_train_ds.targets = np.load("../results/" + args.attack+ "/clean_target.npy", allow_pickle=True)
