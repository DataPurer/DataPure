...
def add_args(parser):
    ...
    parser.add_argument('--yaml_path', type=str, default='../config/attack/ssba/cifar10.yaml',
    ...
    parser.add_argument('--attack_train_replace_imgs_path', type = str, default='../resource/ssba/cifar10_ssba_train_b1.npy')
    parser.add_argument('--attack_test_replace_imgs_path', type = str, default='../resource/ssba/cifar10_ssba_test_b1.npy')
    return parser
